...
export default function Nav() {
    ...
    return (
        <>
      <nav className='relative max-w-[465px] w-full h-[50px] -top-[720px] bg-gradient-to-b from-black to-transparent opacity-90 overflow-x-scroll scrollbar-hide'>
              <div className='relative max-w-[465px] w-full left-0 top-1 border-t border-white'>
