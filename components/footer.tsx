...
export default function Footer() {
    ...
    return (
        ...
        <ExternalLink href="https://creativecommons.org/licenses/by-sa/4.0/">
            <div className="relative max-w-[465px] h-[30px]  text-[15px] text-[#838383] text-center underline underline-offset-2">
                    Unless otherwise stated, all contents here licensed CC BY-SA 4.0
            </div>
        </ExternalLink>
        <div className="relative max-w-[465px] h-[18px] -top-[3px] font-neodgm text-white text-[18px] text-right">
